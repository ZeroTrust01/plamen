...
1. Read the skill file from `~/.codex/plamen/agents/skills/sui/{template-name}/SKILL.md` (folder name is lowercase-hyphenated)
...
1. **Core directives** (~130 lines): Load `~/.codex/plamen/agents/skills/sui/move-safety-core-directives/SKILL.md` into EVERY breadth agent. Counts toward the 300-line cap.
...
for each planned agent:
  ...
  for each SKILL.md assigned:
    wc -l ~/.codex/plamen/agents/skills/sui/{skill-name}/SKILL.md
