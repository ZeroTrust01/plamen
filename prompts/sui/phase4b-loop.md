  ...
  if MODE == THOROUGH:
    spawn checklist_agent(model="haiku", prompt="
      ...
      Depth Agent -> Skill Mapping:
        depth-token-flow -> ~/.codex/plamen/agents/skills/sui/token-flow-tracing/SKILL.md
        depth-state-trace -> ~/.codex/plamen/agents/skills/sui/type-safety/SKILL.md
        depth-edge-case -> ~/.codex/plamen/agents/skills/sui/zero-state-return/SKILL.md
        depth-external -> ~/.codex/plamen/agents/skills/sui/external-precondition-audit/SKILL.md
