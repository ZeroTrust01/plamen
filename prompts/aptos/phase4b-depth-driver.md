...
- `~/.codex/plamen/prompts/aptos/phase4b-depth-templates.md` -- depth agent role definitions and methodology
- `~/.codex/plamen/prompts/aptos/phase4b-scanner-templates.md` -- scanner agent definitions
...
Each depth agent reads its role definition from `~/.codex/plamen/prompts/aptos/phase4b-depth-templates.md` and its full methodology from `~/.codex/plamen/agents/depth-{role}.md`.
...
## Depth Methodology
Read: ~/.codex/plamen/prompts/aptos/phase4b-depth-templates.md -- follow the {ROLE} section
...
Each scanner reads its checks from `~/.codex/plamen/prompts/aptos/phase4b-scanner-templates.md`.

```
You are Blind Spot Scanner {LETTER}: {SCANNER_NAME}.

## Scanner Methodology
Read: ~/.codex/plamen/prompts/aptos/phase4b-scanner-templates.md -- follow Scanner {LETTER} section
...
## Methodology
Read: ~/.codex/plamen/prompts/aptos/phase4b-scanner-templates.md -- follow the Validation Sweep section
