...
> |------|-----------|---------|
> | MR1 | `~/.codex/plamen/agents/skills/aptos/ability-analysis/SKILL.md` | Always |
> | MR2 | `~/.codex/plamen/agents/skills/aptos/bit-shift-safety/SKILL.md` | Always |
> | MR3 | `~/.codex/plamen/agents/skills/aptos/type-safety/SKILL.md` | Always |
> | MR4 | `~/.codex/plamen/agents/skills/aptos/dependency-audit/SKILL.md` | EXTERNAL_LIB flag |
>
