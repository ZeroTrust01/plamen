  ...
  if MODE == THOROUGH:
    spawn checklist_agent(model="haiku", prompt="
      ...
      Depth Agent -> Skill Mapping:
        depth-token-flow -> ~/.codex/plamen/agents/skills/aptos/token-flow-tracing/SKILL.md
        depth-state-trace -> ~/.codex/plamen/agents/skills/aptos/type-safety/SKILL.md
        depth-edge-case -> ~/.codex/plamen/agents/skills/aptos/zero-state-return/SKILL.md
        depth-external -> ~/.codex/plamen/agents/skills/aptos/external-precondition-audit/SKILL.md
