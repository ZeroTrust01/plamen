  ...
  if MODE == THOROUGH:
    spawn checklist_agent(model="haiku", prompt="
      ...
      Depth Agent -> Skill Mapping:
        depth-token-flow -> ~/.codex/plamen/agents/skills/solana/token-flow-tracing/SKILL.md
        depth-state-trace -> ~/.codex/plamen/agents/skills/solana/pda-security/SKILL.md
        depth-edge-case -> ~/.codex/plamen/agents/skills/solana/zero-state-return/SKILL.md
        depth-external -> ~/.codex/plamen/agents/skills/solana/external-precondition-audit/SKILL.md
