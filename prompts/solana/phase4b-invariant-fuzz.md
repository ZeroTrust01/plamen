...
- ~/.codex/plamen/agents/skills/solana/trident-api-reference/SKILL.md (correct API signatures - MUST read before writing any code)
...
(see `~/.codex/plamen/rules/phase5-poc-execution.md` - Non-EVM Fuzz Guidance).
