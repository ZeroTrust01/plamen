...
> **Reference**: Full scoring model, formulas, and routing thresholds are in `~/.codex/plamen/rules/phase4-confidence-scoring.md`.
...
- ~/.codex/plamen/rules/phase4-confidence-scoring.md (full scoring model reference)
